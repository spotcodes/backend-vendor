...
Route::post('uniqueEmailId',[FrontController::class,'uniqueEmailId'])->name('uniqueEmailId');
...
Route::get('payment-cancel', [FrontController::class,'cancel'])->name('payment.cancel');
...
Route::post('addWishList',[FrontController::class,'addWishList']);
...
Route::group(['middleware'=>'admin_auth'],function(){
    ...
    Route::post('admin/emailChange',[AdminController::class,'emailChange']);
    Route::get('/admin/verification_email/{id}',[AdminController::class,'verification_email']);
    Route::get('admin/dashboard',[DashboardController::class,'dashboard']);
    Route::get('admin/dashboard_vendor',[DashboardController::class,'dashboard_vendor']);
    ...
    Route::get('admin/product_review_vendor',[ProductReviewController::class,'product_review_vendor']);
    Route::get('admin/update_product_review_status/{status}/{id}',[ProductReviewController::class,'update_product_review_status']);

    Route::get('admin/order_vendor',[OrderController::class,'order_vendor']);
...
Route::post('product/slugCheck',[ProductController::class,'slugCheck']);
Route::post('product/skuCheck',[ProductController::class,'skuCheck']);
Route::post('category/slugCheck',[CategoryController::class,'slugCheck']);
Route::post('brand/brandCheck',[BrandController::class,'brandCheck']);
Route::post('color/colorCheck',[ColorController::class,'colorCheck']);
Route::post('coupon/couponCheck',[CouponController::class,'couponCheck']);
Route::post('size/sizeCheck',[SizeController::class,'sizeCheck']);
Route::post('tax/tax_valueCheck',[TaxController::class,'tax_valueCheck']);
//Route::get('/admin/export-csv',[OrderController::class,'exportCSV']);
Route::get('admin/export-csv',[OrderController::class,'exportCSV']);
Route::post('admin/fileImport',[ProductController::class,'fileImport'])->name('fileImport');
Route::get('admin/fileExport',[ProductController::class,'fileExport'])->name('fileExport');
Route::get('admin/filePdf',[ProductController::class,'filePdf'])->name('filePdf');
Route::get('admin/barChart',[AdminController::class,'barChart'])->name('barChart');
