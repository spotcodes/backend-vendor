...
<head>
    ...
    <link href="{{asset('admin_assets/css/dataTables.min.css')}}" rel="stylesheet" media="all">
    <script>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                       ...
                       <li class="@yield('dashboard_select')">
                            <a href="{{url('admin/dashboard_vendor')}}">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                        </li>

                        <li class="@yield('category_order')">
                            <a href="{{url('admin/order_vendor')}}">
                            <i class="fas fa-shopping-basket"></i>Order</a>
                        </li>
                       
                        <li class="@yield('product_review_select')">
                            <a href="{{url('admin/product_review_vendor')}}">
                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Welcome {{session()->get('ADMIN_NAME')}}</a>
                                        </div>
