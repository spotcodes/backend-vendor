                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="code" value="{{$code}}" name="code" placeholder="Coupon Code Unique" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                                       <!--- @error('code')
		...
		success:function(result)
			{
			 if(result == 'unique')
			 {
			  $('#error_slug').html('<label class="text-success">Coupon Code Not Available in Database</label>');
			  $('#code').removeClass('has-error');
			  }
			 else
			 {
			  $('#error_slug').html('<label class="text-danger">Coupon Code Already Available in Database</label>');
