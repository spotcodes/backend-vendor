...
<html lang="en">
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>9536754737</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li><span class="aa-cart-notify1" style="color:red;">{{$totalwishListItem}}</span><a href="{{url('wishList')}}">WishList</a>
			      
				  </li><li><a href="{{url('order')}}">My Order</a></li>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>Web<strong>Ecom</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
  ...
  <!---<script src="https://kit.fontawesome.com/68fae1496e.js" crossorigin="anonymous"></script>--->
  </body>
</html>