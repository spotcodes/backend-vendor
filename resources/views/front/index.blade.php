                    ...
                    <div class="tab-pane fade {{$cat_class}}" id="cat{{$list->id}}">
                      ...
                      @if(isset($home_categories_product[$list->id][0]))
                       @foreach($home_categories_product[$list->id] as $productArr)
                        <li>
                          <figure>
                            <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img src="{{asset('storage/media/'.$productArr->image)}}" alt="{{$productArr->name}}" style="width:180px;height:200px" >
                            ...
                            <figcaption>
                              ...
                              <span class="aa-product-price">Rs {{$home_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>Rs {{$home_product_attr[$productArr->id][0]->mrp}}</del><div class="wishlist" onclick="addWishList1('{{$productArr->id}}','{{$home_product_attr[$productArr->id][0]->size}}','{{$home_product_attr[$productArr->id][0]->color}}',{{session()->get('FRONT_USER_LOGIN')}})"><i class="fa fa-heart-o"></i></div></span>
                            </figcaption>
                          </figure>  
