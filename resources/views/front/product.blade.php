                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-prod-view-bottom">
					  ...
					  <a class="aa-add-to-cart-btn" href="javascript:void(0)" onclick="addWishList('{{$product[0]->id}}','{{$product_attr[$product[0]->id][0]->size_id}}','{{$product_attr[$product[0]->id][0]->color_id}}',{{session()->get('FRONT_USER_LOGIN')}}) ">WishList</a>
                       <a class="aa-add-to-cart-btn" id="cartView" href="{{url('cart')}}" style="display:none">Cart</a>
                ...
                <div class="tab-pane fade " id="review">
                 ...
                 @if(isset($product_review[0]))    
                            ...
                            <div class="rating-css">
                                <div class="star-icon">
                                    @for($i=1;$i<=$list->rating;$i++)
                                      <input type="radio" value="{{$list->rating}}" name="rating" checked id="rating1">
                   ...
                   @else
                      ...
                      @endif
                   <form id="frmProductReview" class="aa-review-form1">
                   <h4>Add a review</h4>
                   <div class="rating-css">
                      <div class="star-icon">
                         <p>Your Rating</p>
                   ...
                   <!-- review form -->
                      ...
                      <button type="submit" class="btn btn-success aa-review-submit">Submit</button>
