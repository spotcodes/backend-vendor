                      ...
                      <div id="collapseFour" class="panel-collapse collapse in">
                        <div class="panel-body">
                         <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="aa-checkout-single-bill">
                                <input type="tel" placeholder="Phone*" value="{{$customers['mobile']}}" name="mobile" class="numericOnly" maxlength="10" required>
                              </div>
                            </div>
                          </div> 
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="aa-checkout-single-bill">
                                <input type="text" placeholder="City / Town*" value="{{$customers['city']}}" onkeypress="return ValidateAlpha(event);" name="city" required>
                              </div>
                            </div>
							<div class="col-md-4">
                              <div class="aa-checkout-single-bill">
                                <input type="text" placeholder="State*" value="{{$customers['state']}}" onkeypress="return ValidateAlpha(event);" name="state" required>
                              </div>                             
                            </div>
                            <div class="col-md-4">
                              <div class="aa-checkout-single-bill">
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
					...
					--->
					<label for="paypal">
                    <input type="radio" id="paypal" name="payment_type" value="Gateway"> Via Paypal </label>
